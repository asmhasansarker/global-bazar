    ...
    return (
        <footer className='bg-[#F3F6Fa]'>
                ...
                <div className='w-3/12 lg:w-4/12 sm:w-full'>
                    <div className='flex flex-col gap-3'>
                        ...
                        <ul className='flex flex-col gap-2 text-slate-600'>
                            <li>Address : Dhaka , Narayanganj</li>
                            <li>Phone : 5873458345</li>
                            <li>Email : hasan@gmail.com</li>
                        </ul>
                    </div>
                </div>
            ...
            <div className='w-[85%] flex flex-wrap justify-center items-center text-slate-600 mx-auto py-5 text-center'>
                <span>Copyright ©2023 All rights reserved | made by <a className='text-blue-500 underline' href="/">@Hasan Sarker</a></span>
            </div>
        </footer>
    )
}
